...
import { PenTool, Calendar, Settings, Sun, Moon, X, Lock, ChevronLeft, ChevronRight, Trash2, Info, LogOut, Archive, Mail } from 'lucide-react'
      ...
      <div className="h-64 overflow-y-auto mb-4 space-y-2">
        {chatMessages.map((message, index) => (
          ...
          >
            ...
            } font-['Open Sans', sans-serif] max-w-[80%]`}>
              {message.content}
            </span>
          </motion.div>
        ))}
  ...
  return (
    <div className={`h-full p-4 overflow-y-auto transition-all duration-300 ${
      ...
      <div className={`mt-4 text-sm font-['Open Sans', sans-serif] ${
        theme === 'dark' || calendarMode !== 'overlay' ? 'text-white' :
        'text-gray-800'
      }`}>
...
function SettingsModal({ userName, saveUserProfile, closeModal, theme, setTheme, deleteEntries }: {
  userName: string
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-800'} font-['Open Sans', sans-serif]`}>
          Ella is a simple journaling app designed to help you reflect on your emotions and experiences. All your entries are stored locally on your device.
        </p>
