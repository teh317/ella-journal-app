...
export default function EllaApp() {
  ...
  const getSuggestedPrompt = () => {
    ...
    if (mostFrequentMood) {
      return `I've noticed you've been feeling ${mostFrequentMood.toLowerCase()} lately. How are you doing today?`;
    }

    return moodPrompts[currentMood][Math.floor(Math.random() * moodPrompts[currentMood].length)];
  };
